...
import { ChevronLeft, ChevronRight, Edit, Camera, User, Mail, Phone, Calendar, Shield, Award, Gift, CreditCard, Smartphone, Bell, HelpCircle, FileText, Settings, LogOut, Send, History, Plane, Euro, DollarSign, Target, Plus, Trash2, CheckCircle, XCircle, Eye, EyeOff, Lock, Unlock, Key, Copy, Download, MapPin, Search, MessageCircle, ArrowLeft, Loader2, RefreshCw, Monitor, Tablet, Globe, Clock, UserCog, ShieldCheck, PieChart, Ticket, Bot, ChevronDown, QrCode, CheckCheck, AlertCircle, AlertTriangleIcon, Info, X, Paperclip, AlertTriangleIcon as AlertTriangleIcon2, ArrowRightLeft, Receipt, Navigation, Home, Car, TrendingDown } from "lucide-react"
...
export function MoreView({ onLogout }: MoreViewProps) {
  const {
    ...
    rewardRedemptions,
    redeemPoints,
    addRewardRedemption, // Added for reward redemption history
    supportTickets,
    createSupportTicket,
    addTicketMessage,
    faqs,
      ...
      <div className="pb-24 space-y-6">
        ...
        <Card className="p-4 space-y-4 border-red-200 bg-red-50/50 dark:bg-red-950/20">
          <div className="flex items-center gap-3 text-red-600">
            <AlertTriangleIcon2 className="h-6 w-6" />
      ...
      <div className="pb-24 space-y-6">
        ...
        <Card className="p-4">
          <div className="flex items-center gap-3 p-3 bg-blue-50 rounded-lg">
            <Globe className="h-5 w-5 text-[#0a4fa6]" />
            <div>
              <p className="text-sm font-medium text-[#0a4fa6]">Device Management</p>
              <p className="text-xs text-muted-foreground">
                {safeLinkedDevices.length} device{safeLinkedDevices.length !== 1 ? "s" : ""} connected to your account
              </p>
            </div>
          </div>
        </Card>
            ...
            safeLinkedDevices.map((device) => (
              <div key={device.id} className="p-4 border rounded-lg space-y-3">
                <div className="flex items-start justify-between">
                  <div className="flex items-center gap-3">
                    <div
                      className={`h-12 w-12 rounded-full flex items-center justify-center ${device.current ? "bg-green-100" : "bg-muted"}`}
                    >
                      {device.type === "mobile" ? (
                        <Smartphone
                          className={`h-6 w-6 ${device.current ? "text-green-600" : "text-muted-foreground"}`}
                        />
                      ) : device.type === "tablet" ? (
                        <Tablet className={`h-6 w-6 ${device.current ? "text-green-600" : "text-muted-foreground"}`} />
                      ) : (
                        <Monitor className={`h-6 w-6 ${device.current ? "text-green-600" : "text-muted-foreground"}`} />
                      )}
                    </div>
                    <div>
                      <div className="flex items-center gap-2">
        ...
        <Button
          ...
          onClick={() => {
            ...
            const otherDevices = safeLinkedDevices.filter((d) => !d.current)
            ...
            toast({
              ...
              description: `${otherDevices.length} device(s) have been removed from your account.`,
            })
          }}
          disabled={safeLinkedDevices.filter((d) => !d.current).length === 0}
        >
          Sign Out All Other Devices
        </Button>

        <div className="bg-blue-50 p-3 rounded-md text-sm text-[#0a4fa6]">
              ...
              <div className="flex items-center gap-3">
                ...
                >
                  {login.status === "success" ? (
                    ...
                    <AlertTriangleIcon2 className="h-5 w-5 text-yellow-600" />
                  ) : (
    ...
    return (
      <div className="pb-24 space-y-6">
        ...
        <div className="bg-amber-50 p-3 rounded-md text-sm text-amber-800">
          <div className="flex items-start gap-2">
            <AlertTriangleIcon2 className="h-4 w-4 mt-0.5" />
            <div>
  ...
  if (currentView === "settings") {
    return (
      <div className="pb-24 space-y-6">
        ...
        {/* Display Preferences */}
        <Card className="p-4 space-y-4">
          <h3 className="font-semibold text-[#0a4fa6]">Display Preferences</h3>
          <div className="flex items-center justify-between">
            <div>
          ...
          <div className="flex items-center justify-between">
            <div>
              <p className="font-medium">Quick Balance</p>
              <p className="text-sm text-muted-foreground">Show balance on lock screen</p>
            </div>
            <Switch
              checked={appSettings?.quickBalanceEnabled || false}
              onCheckedChange={(checked) => {
                updateAppSettings({ quickBalanceEnabled: checked })
                handleToggle("Quick Balance", checked)
              }}
            />
          </div>
        </Card>
        ...
        {/* Language & Region */}
        <Card className="p-4 space-y-4">
          <h3 className="font-semibold text-[#0a4fa6]">Language & Region</h3>
          <div className="space-y-2">
            ...
            <Select
              ...
              onValueChange={(value) => {
                ...
                toast({ title: "Language Updated", description: `Language changed to ${value}` })
                addActivity({
                  action: `Language changed to ${value}`,
                  device: detectDeviceInfo().deviceName,
                  location: "Current Location",
                })
              }}
          ...
          <div className="space-y-2">
            ...
            <Select
              value={safeUserProfile?.timezone || "America/New_York"}
              onValueChange={(value) => {
                updateUserProfile({ timezone: value })
                toast({ title: "Time Zone Updated", description: "Your time zone has been changed" })
                addActivity({
                  action: `Time zone changed to ${value}`,
                  device: detectDeviceInfo().deviceName,
                  location: "Current Location",
                })
              }}
          ...
          <div className="space-y-2">
            ...
            <Select
              ...
              onValueChange={(value) => {
                updateAppSettings({ currency: value })
                toast({ title: "Currency Updated", description: `Currency changed to ${value}` })
                addActivity({
                  action: `Currency changed to ${value}`,
                  device: detectDeviceInfo().deviceName,
                  location: "Current Location",
                })
              }}
        ...
        <Card className="p-4 space-y-4">
          <h3 className="font-semibold text-[#0a4fa6]">Notifications</h3>
          <div className="flex items-center justify-between">
            <div>
            ...
            <Switch
              checked={appSettings?.pushNotifications || false}
              onCheckedChange={(checked) => {
                updateAppSettings({ pushNotifications: checked })
          ...
          <div className="flex items-center justify-between">
            ...
            <Switch
              checked={appSettings?.emailNotifications || false}
              onCheckedChange={(checked) => {
                updateAppSettings({ emailNotifications: checked })
          ...
          <div className="flex items-center justify-between">
            ...
            <Switch
              checked={appSettings?.smsAlerts || false}
              onCheckedChange={(checked) => {
                updateAppSettings({ smsAlerts: checked })
                handleToggle("SMS Alerts", checked)
              }}
            />
          </div>
          <div className="flex items-center justify-between">
            ...
            <Switch
              checked={appSettings?.transactionAlerts || false}
              onCheckedChange={(checked) => {
                updateAppSettings({ transactionAlerts: checked })
          ...
          <div className="flex items-center justify-between">
            ...
            <Switch
              checked={appSettings?.balanceAlerts || false}
              onCheckedChange={(checked) => {
                updateAppSettings({ balanceAlerts: checked })
                handleToggle("Balance Alerts", checked)
              }}
            />
          </div>
          {appSettings?.balanceAlerts && (
            <div className="space-y-2 pl-4 border-l-2 border-[#0a4fa6]">
              <Label>Alert Threshold</Label>
              <Input
                type="number"
                value={appSettings?.balanceThreshold || 100}
                onChange={(e) => {
                  updateAppSettings({ balanceThreshold: Number.parseInt(e.target.value) })
                  toast({ title: "Threshold Updated", description: "Balance alert threshold has been changed" })
                }}
              />
          ...
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-sm text-muted-foreground">Notify on new sign-ins</p>
            </div>
            <Switch
              checked={appSettings?.loginAlerts || false}
              onCheckedChange={(checked) => {
                updateAppSettings({ loginAlerts: checked })
        ...
        {/* Account Preferences */}
        <Card className="p-4 space-y-4">
          <h3 className="font-semibold text-[#0a4fa6]">Account Preferences</h3>
          <div className="flex items-center justify-between">
            <div>
              <p className="font-medium">Paperless Statements</p>
              <p className="text-sm text-muted-foreground">Go paperless for statements</p>
            </div>
            <Switch
              checked={appSettings?.paperlessStatements || false}
              onCheckedChange={(checked) => {
                updateAppSettings({ paperlessStatements: checked })
                handleToggle("Paperless Statements", checked)
              }}
            />
          </div>
          <div className="flex items-center justify-between">
            ...
            <Switch
              checked={appSettings?.marketingEmails || false}
              onCheckedChange={(checked) => {
                updateAppSettings({ marketingEmails: checked })
          ...
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-sm text-muted-foreground">Auto-save spare change</p>
            </div>
            <Switch
              checked={appSettings?.roundUpSavings || false}
              onCheckedChange={(checked) => {
                updateAppSettings({ roundUpSavings: checked })
                handleToggle("Round-Up Savings", checked)
              }}
            />
          </div>
        </Card>
        ...
        {/* Biometric & Login */}
        <Card className="p-4 space-y-4">
          <h3 className="font-semibold text-[#0a4fa6]">Biometric & Login</h3>
          <div className="flex items-center justify-between">
            <div>
            ...
            <Switch
              checked={appSettings?.biometricLogin || false}
              onCheckedChange={(checked) => {
                updateAppSettings({ biometricLogin: checked })
                handleToggle("Biometric Login", checked)
              }}
            />
          </div>
          <div className="flex items-center justify-between">
            ...
            <Switch
              ...
              onCheckedChange={(checked) => {
                updateAppSettings({ autoLockEnabled: checked })
                handleToggle("Auto Lock", checked)
              }}
            />
          </div>
          {appSettings?.autoLockEnabled && (
            <div className="space-y-2 pl-4 border-l-2 border-[#0a4fa6]">
              ...
              <Select
                value={appSettings?.sessionTimeout?.toString() || "15"}
                onValueChange={(value) => {
                  updateAppSettings({ sessionTimeout: Number.parseInt(value) })
                  toast({ title: "Timeout Updated", description: `Session timeout set to ${value} minutes` })
                }}
              >
                <SelectTrigger>
                  <SelectValue />
        ...
        {/* Privacy Settings */}
        <Card className="p-4 space-y-4">
          <h3 className="font-semibold text-[#0a4fa6]">Privacy</h3>
          <div className="flex items-center justify-between">
            <div>
              <p className="font-medium">Share Data with Partners</p>
              <p className="text-sm text-muted-foreground">Allow data sharing</p>
            </div>
            <Switch
              checked={appSettings?.privacySettings?.shareDataWithPartners || false}
              onCheckedChange={(checked) => {
                updateAppSettings({
                  privacySettings: { ...appSettings.privacySettings, shareDataWithPartners: checked },
                })
                handleToggle("Data Sharing", checked)
              }}
            />
          </div>
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-sm text-muted-foreground">Show relevant ads</p>
            </div>
            <Switch
              checked={appSettings?.privacySettings?.personalizedAds || false}
              onCheckedChange={(checked) => {
                updateAppSettings({
                  privacySettings: { ...appSettings.privacySettings, personalizedAds: checked },
                })
                handleToggle("Personalized Ads", checked)
              }}
            />
          </div>
          <div className="flex items-center justify-between">
            ...
            <Switch
              checked={appSettings?.privacySettings?.locationServices || false}
              onCheckedChange={(checked) => {
                updateAppSettings({
                  privacySettings: { ...appSettings.privacySettings, locationServices: checked },
                })
          ...
          <div className="flex items-center justify-between">
            ...
            <Switch
              checked={appSettings?.privacySettings?.analyticsTracking || false}
              onCheckedChange={(checked) => {
                updateAppSettings({
                  privacySettings: { ...appSettings.privacySettings, analyticsTracking: checked },
                })
                handleToggle("Analytics Tracking", checked)
              }}
            />
          </div>
        </Card>
        ...
        {/* Data Permissions */}
        <Card className="p-4 space-y-4">
          <h3 className="font-semibold text-[#0a4fa6]">Data Permissions</h3>
          <p className="text-sm text-muted-foreground mb-2">Manage app permissions for accessing device features</p>
          <div className="flex items-center justify-between">
            <div>
              <p className="font-medium">Camera Access</p>
              <p className="text-sm text-muted-foreground">For check deposits & profile photos</p>
            </div>
            <Switch
              checked={appSettings?.dataPermissions?.cameraAccess || false}
              onCheckedChange={(checked) => {
                updateAppSettings({
                  dataPermissions: { ...appSettings.dataPermissions, cameraAccess: checked },
                })
                handleToggle("Camera Access", checked)
              }}
            />
          </div>
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-sm text-muted-foreground">Access photos & images</p>
            </div>
            <Switch
              checked={appSettings?.dataPermissions?.photoLibrary || false}
              onCheckedChange={(checked) => {
                updateAppSettings({
                  dataPermissions: { ...appSettings.dataPermissions, photoLibrary: checked },
                })
                handleToggle("Photo Library", checked)
              }}
            />
          </div>
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-sm text-muted-foreground">Access contacts for payments</p>
            </div>
            <Switch
              checked={appSettings?.dataPermissions?.contacts || false}
              onCheckedChange={(checked) => {
                updateAppSettings({
                  dataPermissions: { ...appSettings.dataPermissions, contacts: checked },
                })
                handleToggle("Contacts", checked)
              }}
            />
          </div>
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-sm text-muted-foreground">Find nearby ATMs & branches</p>
            </div>
            <Switch
              checked={appSettings?.dataPermissions?.location || false}
              onCheckedChange={(checked) => {
                updateAppSettings({
                  dataPermissions: { ...appSettings.dataPermissions, location: checked },
                })
          ...
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-sm text-muted-foreground">Show app notifications</p>
            </div>
            <Switch
              checked={appSettings?.dataPermissions?.notifications || false}
              onCheckedChange={(checked) => {
                updateAppSettings({
                  dataPermissions: { ...appSettings.dataPermissions, notifications: checked },
                })
          ...
          <div className="flex items-center justify-between">
            ...
            <Switch
              checked={appSettings?.dataPermissions?.faceId || false}
              onCheckedChange={(checked) => {
                updateAppSettings({
                  dataPermissions: { ...appSettings.dataPermissions, faceId: checked },
                })
          ...
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-sm text-muted-foreground">Fingerprint authentication</p>
            </div>
            <Switch
              checked={appSettings?.dataPermissions?.touchId || false}
              onCheckedChange={(checked) => {
                updateAppSettings({
                  dataPermissions: { ...appSettings.dataPermissions, touchId: checked },
                })
                handleToggle("Touch ID", checked)
              }}
            />
          </div>
        </Card>
        ...
        <Card className="p-4 space-y-4">
          <h3 className="font-semibold text-[#0a4fa6]">Accessibility</h3>
          <p className="text-sm text-muted-foreground mb-2">Customize your experience for better accessibility</p>
          <div className="space-y-2">
            <Label>Text Size</Label>
            <Select
              value={appSettings?.textSize || "medium"}
              onValueChange={(value) => {
                updateAppSettings({ textSize: value })
                toast({ title: "Text Size Updated", description: `Text size changed to ${value}` })
              }}
            >
              <SelectTrigger>
                <SelectValue />
          ...
          <div className="flex items-center justify-between">
            ...
            <Switch
              checked={appSettings?.highContrast || false}
              onCheckedChange={(checked) => {
                updateAppSettings({ highContrast: checked })
                handleToggle("High Contrast", checked)
              }}
            />
          </div>
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-sm text-muted-foreground">Minimize animations & transitions</p>
            </div>
            <Switch
              checked={appSettings?.reduceMotion || false}
              onCheckedChange={(checked) => {
                updateAppSettings({ reduceMotion: checked })
                handleToggle("Reduce Motion", checked)
              }}
            />
          </div>
          <div className="flex items-center justify-between">
            ...
            <Switch
              checked={appSettings?.screenReader || false}
              onCheckedChange={(checked) => {
                updateAppSettings({ screenReader: checked })
                handleToggle("Screen Reader", checked)
              }}
            />
          </div>
          <div className="flex items-center justify-between">
            ...
            <Switch
              checked={appSettings?.voiceControl || false}
              onCheckedChange={(checked) => {
                updateAppSettings({ voiceControl: checked })
                handleToggle("Voice Control", checked)
              }}
            />
          </div>
        </Card>
                ...
                <div className="flex items-start justify-between">
                  <div className="flex-1">
                    <div className="flex items-center gap-2">
                      ...
                      {notification.type === "alert" && <AlertTriangleIcon className="h-5 w-5 text-red-600" />}
