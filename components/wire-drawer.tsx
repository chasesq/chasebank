    ...
    <div className="px-4 space-y-6 overflow-y-auto pb-4">
      <div className="text-center">
        ...
        <p className="text-sm text-muted-foreground mt-1">
          ...
          <br />
          <span className="font-medium text-foreground">Customer Support Email</span>
        </p>
      </div>
      ...
      <div className="bg-blue-50 dark:bg-blue-950/30 p-4 rounded-lg text-sm">
        ...
        <p className="text-blue-800 dark:text-blue-200 text-xs">
          Your OTP verification code has been sent to our customer service team at{" "}
      ...
      <div className="bg-amber-50 dark:bg-amber-950/30 p-4 rounded-lg text-sm space-y-3">
        ...
        <ul className="text-amber-800 dark:text-amber-200 text-xs space-y-2">
          <li className="flex items-start gap-2">
            ...
            <span>Check your email inbox and spam folder for messages from Chase</span>
          </li>
          <li className="flex items-start gap-2">
          ...
          <li className="flex items-start gap-2">
            ...
            <span>Contact Customer Support to receive your OTP code</span>
          </li>
        </ul>
      </div>

      <div className="bg-muted/50 p-4 rounded-lg text-xs space-y-2">
        <p className="font-semibold text-foreground">Contact Customer Support:</p>
        ...
        <p className="text-muted-foreground mt-2">
          Our support team will provide you with the verification code after confirming your identity.
        </p>
      </div>
    </div>
  )
