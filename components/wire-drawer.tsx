...
type VerificationStep = "form" | "options" | "review" | "otp" | "cot" | "tax" | "processing" | "complete" | "success"
...
export function WireDrawer({ open, onOpenChange, onReceiptOpen }: WireDrawerProps) {
  ...
  const [selectedWireOption, setSelectedWireOption] = useState("")
  ...
  const handleProceedToReview = () => {
    if (!selectedWireOption) {
      toast({
        title: "No Option Selected",
        description: "Please select a wire transfer option to proceed",
        variant: "destructive",
      })
      return
    }
