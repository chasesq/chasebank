  ...
  const handleSignupSubmit = async () => {
    if (signupStep === 1) {
      ...
      try {
        ...
        console.log("[v0] User created successfully with ID:", data.userId)
        ...
        toast({
          ...
          description: `Welcome to Chase! A verification token has been sent to ${signupData.email}. You can now sign in with your credentials.`,
        })
