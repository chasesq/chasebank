...
export function QuickActions({
  ...
  return (
    <div className="flex gap-3 overflow-x-auto pb-2 px-1 scrollbar-hide">
      <Button
        variant="outline"
        className="flex items-center justify-center bg-card border-0 chase-card-shadow hover:bg-muted/50 rounded-full h-12 w-12 p-0 flex-shrink-0"
      ...
      <Button
        variant="outline"
        className="flex items-center gap-2 whitespace-nowrap bg-card border-0 chase-card-shadow hover:bg-muted/50 rounded-full h-12 px-5 font-medium flex-shrink-0"
        onClick={onSendMoney}
      >
