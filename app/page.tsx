...
import { useDataLoaderMultiple, useDataLoaderWait } from "@/hooks/use-data-loader"
...
export default function Page() {
  ...
  const { isLoading: isPreloading, isReady: isDataLoaded } = useDataLoaderMultiple(
    {
  ...
  // Show loading state while checking auth or preloading data
